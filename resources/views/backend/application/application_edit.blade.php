                        ...
                        <form action="{{ route('application.update', $application->id) }}" method="POST"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="maritial_status" name="maritial_status" class="form-control" required>
                                            <option value="Single"
                                                {{ $application->maritial_status == 'Single' ? 'selected' : '' }}>Single
                                            </option>
                                            <option value="Married"
                                                {{ $application->maritial_status == 'Married' ? 'selected' : '' }}>Married
                                            </option>
                                            <option value="Other"
                                                {{ $application->maritial_status == 'Other' ? 'selected' : '' }}>Other
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="passport"
                                            value="{{ $application->passport }}" required></td>

                                    <td class="font-weight-bold">Passport Expire Date <span class="text-danger">*</span>
                                    </td>
                                    <td><input class="datepicker form-control" name="passport_expire"
                                            data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" required
                                            autocomplete="off" value="{{ $application->passport_expire }}" required></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Nationality <span class="text-danger">*</span></td>
                                    <td><input class="form-control" type="text" name="nationality"
                                            value="{{ $application->nationality }}" required></td>

                                    <td class="font-weight-bold">Country of Residence <span class="text-danger">*</span>
                                    </td>
                                    <td><input class="form-control" type="text" name="country_of_residence"
                                            value="{{ $application->country_of_residence }}" required></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Address <span class="text-danger">*</span></td>
                                    <td colspan="3"><input class="form-control" type="text" name="address"
                                            value="{{ $application->address }}" required></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">SSC/Equivalent <span class="text-danger">*</span></td>
                                    <td><input class="form-control" type="text" name="ssc"
                                            value="{{ $application->ssc }}" required></td>

                                    <td class="font-weight-bold">Year of Completion <span class="text-danger">*</span></td>
                                    <td><input class="form-control" type="text" name="ssc_year"
                                            value="{{ $application->ssc_year }}" required></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Institute</td>
                                    <td><input class="form-control" type="text" name="ssc_institute"
                                            value="{{ $application->ssc_institute }}"></td>

                                    <td class="font-weight-bold">CGPA <span class="text-danger">*</span></td>
                                    <td><input class="form-control" type="text" name="ssc_cgpa"
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="bachelor"
                                            value="{{ $application->bachelor }}"></td>

                                    <td class="font-weight-bold">Year of Completion</td>
                                    <td><input class="form-control" type="text" name="bachelor_year"
                                            value="{{ $application->bachelor_year }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Institute</td>
                                    <td><input class="form-control" type="text" name="bachelor_institute"
                                            value="{{ $application->bachelor_institute }}"></td>

                                    <td class="font-weight-bold">CGPA</td>
                                    <td><input class="form-control" type="text" name="bachelor_cgpa"
                                            value="{{ $application->bachelor_cgpa }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Master/Equivalent</td>
                                    <td><input class="form-control" type="text" name="master"
                                            value="{{ $application->master }}"></td>

                                    <td class="font-weight-bold">Year of Completion</td>
                                    <td><input class="form-control" type="text" name="master_year"
                                            value="{{ $application->master_year }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Institute</td>
                                    <td><input class="form-control" type="text" name="master_institute"
                                            value="{{ $application->master_institute }}"></td>

                                    <td class="font-weight-bold">CGPA</td>
                                    <td><input class="form-control" type="text" name="master_cgpa"
                                            value="{{ $application->master_cgpa }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Proof of Language (IELTS/TOEFL/etc) </td>
                                    <td colspan="3"><input class="form-control" type="text" name="proof_of_language" value="{{ $application->proof_of_language }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">IELTS Score (if any)</td>
                                    <td><input class="form-control" type="text" name="ielts"
                                            value="{{ $application->ielts }}"></td>

                                    <td class="font-weight-bold">Study Destination (if any)</td>
                                    <td><input class="form-control" type="text" name="study_destination"
                                            value="{{ $application->study_destination }}"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select id="intake_month" name="intake_month" class="form-control">
                                            ...
                                            <option value="February"
                                                {{ $application->intake_month == 'February' ? 'selected' : '' }}>February
                                            </option>
                                            <option value="September"
                                                {{ $application->intake_month == 'September' ? 'selected' : '' }}>
                                                September</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="prepared_institution1"
                                            value="{{ $application->prepared_institution1 }}"></td>

                                    <td class="font-weight-bold">Subject of Interest (if any)</td>
                                    <td><input class="form-control" type="text" name="subject_of_interest1"
                                            value="{{ $application->subject_of_interest1 }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Prepared Institution 2 (if any)</td>
                                    <td><input class="form-control" type="text" name="prepared_institution2"
                                            value="{{ $application->prepared_institution2 }}"></td>

                                    <td class="font-weight-bold">Subject of Interest (if any)</td>
                                    <td><input class="form-control" type="text" name="subject_of_interest2"
                                            value="{{ $application->subject_of_interest2 }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">How do you know about us?</td>
                                    <td>
                                        <select id="source" name="source" class="form-control">
                                            <option value="" {{ $application->source == '' ? 'selected' : '' }}>
                                            </option>
                                            <option value="Social Media"
                                                {{ $application->source == 'Social Media' ? 'selected' : '' }}>Social
                                                Media</option>
                                            <option value="Google"
                                                {{ $application->source == 'Google' ? 'selected' : '' }}>Google</option>
                                            <option value="Agent"
                                                {{ $application->source == 'Agent' ? 'selected' : '' }}>Agent</option>
                                            <option value="Newspaper"
                                                {{ $application->source == 'Newspaper' ? 'selected' : '' }}>Newspaper
                                            </option>
                                        </select>
                                    </td>
                                        ...
                                        <select id="referrer" name="referrer" class="form-control">
                                            ...
                                            @foreach ($agents as $agent)
                                                <option value="{{ $agent->id }}"
                                                    {{ $agent->id == $application->referrer ? 'selected' : '' }}>
                                                    {{ $agent->name }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @role('admin')
                                            <select id="status" name="status" class="form-control">
                                                ...
                                                @foreach ($status as $st)
                                                    <option value="{{ $st->id }}"
                                                        {{ $st->id == $application->status ? 'selected' : '' }}>
                                                        {{ $st->name }}</option>
                                                @endforeach
                                            </select>
                                        @endrole
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input class="form-control" type="text" name="remarks"
                                            value="{{ $application->remarks }}"></td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Comments</td>
                                    <td colspan="3"><input class="form-control" type="text" name="comments"
                                            value="{{ $application->comments }}"></td>
                                </tr>
                                <tr>
                                    <td>
